...
const Tablero = () => {
  ...
  let [ganador1, setGanador1] = useState("");
  ...
  let [numJugadoresEquipo, setNumJugadoresEquipo] = useState(0)
  ...
  let [vectorEquipo1, setVectorEquipo1] = useState([ { nombre1:"", nombre2:"", quesitos:[], ficha1:"", ficha2:"" }])
  let [vectorEquipo3, setVectorEquipo3] = useState([ { nombre1:"", nombre2:"", quesitos:[], ficha1:"", ficha2:"" }])
  ...
  const posv1 = [{top:"5%", left:"22%"} /*, {top:"29%", left:"22%"}*/]
  const posv2 = [{top:"5%", left:"70%"} /*{top:"5%", left:"70%"}, {top:"57%", left:"70%"}*/]
  const posv3 = [{top:"29%", left:"22%"}/*{top:"5%", left:"70%"}, {top:"57%", left:"70%"}*/]
      ...
      try {
        ...
        if (String(data.type) == ""){
          ...
          if (msgIni==0) {
            ...
            var0 = 0
            if ((vector1.length + vector2.length) == 4){
              var1 = 0
            }
            var2 = 0
            for (let i=0; i < vector2.length; i++) {
              ...
              if (vector2[i].equipo == 0){
                ...
                if (var2 == 0){
                  vectorEquipo3[0].nombre1 = vector2[i].nombre
                  vectorEquipo3[0].ficha1 = vector2[i].ficha
                  vectorEquipo3[0].quesitos = vector2[i].quesitos
                } else {
                  vectorEquipo3[0].nombre2 = vector2[i].nombre
                  vectorEquipo3[0].ficha2 = vector2[i].ficha
                }
                var2 = var2 + 1
              }
            }
            ...
            switch(data.type) {
              ...
              case "Fin":
                console.log("Accion --> FIN")
                  ...
                  if (ganador == usuario || ganador1 == usuario) {
                  ...
                  case "Contestar_pregunta":
                    ...
                    if (String(data.enunciado) == "noContestada") {
                      ...
                      if(data.quesito == true && data.esCorrecta == "true"){
                        ...
                        else if (vectorEquipoTurno == "equipo2"){
                          setVectorEquipo2[0].quesitos.push(varAux)
                        }
                        else {
                          vectorEquipo3[0].quesitos.push(varAux)
                        }
                        setVectorEquipo1(vectorEquipo1)
                        setVectorEquipo2(vectorEquipo2)
                        setVectorEquipo3(vectorEquipo3)
                      }
  ...
  function posicionElementos() {
    if (vectorEquipoTurno == "equipo1"){
      return (
        <div style={{ position:"absolute", top:posv1[0].top, left:posv1[0].left, height:"26.5%", width:"9%"}}> { } 
      ...
      //console.log(indiceJugadorTurno + " " + vectorJugadorTurno)
      return (
        <div style={{ position:"absolute", top:posv2[0].top, left:posv2[0].left, height:"26.5%", width:"9%"}}> {/*Nos falta añadir los porcentajes de top y left*/ } 
            <div style={{position:"absolute", left:"19%", top:"5%"}}>
                {RelojJugada()}
            </div >
            <div style={{position:"absolute", left:"26%",top:"-100%", cursor:"pointer", zIndex:"5"}} onClick={() => {
      ...
      return (
        <div style={{ position:"absolute", top:posv3[0].top, left:posv3[0].left, height:"26.5%", width:"9%"}}> {/*Nos falta añadir los porcentajes de top y left*/ } 
            <div style={{position:"absolute", left:"19%", top:"5%"}}>
                {RelojJugada()}
            </div >
            <div style={{position:"absolute", left:"26%",top:"-100%", cursor:"pointer", zIndex:"5"}} onClick={() => {
  ...
  function jugadores3(){
    if ((vector1.length + vector2.length) == 6) {
      return vectorEquipo3.map((props) => (
        <div style={{ width: "94%", height: "92%", position: "absolute", zIndex: "0", top:`4%`, left:"3%"}}>  
          <div className='App-EsJugador' style={{top: `${(1 % 3) * 30}%`, left:"0%", width: "30%", height: "30%"}} >
  ...
  function fun_colorTematica(tematicaPregunta){
    switch(tematicaPregunta){
      case "Ciencia":
        setColorTematica("#73fc67")
      break
      case "Arte":
        setColorTematica("#fc6767")
      break
      case "Deportes":
        setColorTematica("#fcbb67")
      break
      case "Entretenimiento":
        setColorTematica("pink")
      break
      case "Geografia":
        setColorTematica("#61dafb")
      break
      case "Historia":
        setColorTematica("#fcf267")
      break
    }
  }
        ...
        {show4 ? (
          <div>
            ...
            <div style={{ position: "absolute", zIndex: "3", height:"700px", width:"700px", top:"7%", left:"30%"}}>
                {/* --- TABLERO --- */}  
                <Linea height="10.5%" width="37%" top="75.5%" left="35%" c1="#61dafb" c2="#DCDCDC" c3="#fc6767" c4="#fcf267" c5="#DCDCDC" c6="#fcbb67" width1="15%" transform="rotate(180deg)" v1={1} v2={2} v3={3} v4={4} v5={5} v6={6}/> 
                <Linea height="10.5%" width="37%" top="55.5%" left="70.5%" c1="#fc6767" c2="#DCDCDC" c3="#73fc67" c4="#fcbb67" c5="#DCDCDC" c6="#61dafb" width1="15%" transform="rotate(120deg)" v1={8} v2={9} v3={10} v4={11} v5={12} v6={13}/>  
                <Linea height="10.5%" width="37%" top="14%" left="70.5%" c1="#73fc67" c2="#DCDCDC" c3="pink" c4="#61dafb" c5="#DCDCDC" c6="#fc6767" width1="15%" transform="rotate(60deg)" v1={15} v2={16} v3={17} v4={18} v5={19} v6={20}/> 
                <Linea height="10.5%" width="37%" top="-6.5%" left="35.5%" c1="pink" c2="#DCDCDC" c3="#fcf267" c4="#fc6767" c5="#DCDCDC" c6="#73fc67" width1="15%" transform="" v1={22} v2={23} v3={24} v4={25} v5={26} v6={27}/>  
                <Linea height="10.5%" width="37%" top="14%" left="0%" c1="#fcf267" c2="#DCDCDC" c3="#fcbb67" c4="#73fc67" c5="#DCDCDC" c6="pink" width1="15%" transform="rotate(-60deg)" v1={29} v2={30} v3={31} v4={32} v5={33} v6={34}/>
                <Linea height="10.5%" width="37%" top="55.5%" left="0%" c1="#fcbb67" c2="#DCDCDC" c3="#61dafb" c4="pink" c5="#DCDCDC" c6="#fcf267" width1="15%" transform="rotate(-120deg)" v1={36} v2={37} v3={38} v4={39} v5={40} v6={41}/> 
                
                
                <Linea height="10%" width="41%" top="60%" left="18.6%" c1="#DCDCDC" c2="#fcbb67" c3="#fcf267" c4="#61dafb" c5="#fc6767" c6="pink" width1="25%" transform="rotate(-60deg)" v1={46} v2={45} v3={44} v4={43} v5={42} v6=""/> 
                <Linea height="10%" width="41%" top="60%" left="47.6%" c1="#DCDCDC" c2="#61dafb" c3="#fcbb67" c4="#fc6767" c5="#73fc67" c6="#fcf267" width1="25%" transform="rotate(-120deg)" v1={51} v2={50} v3={49} v4={48} v5={47} v6=""/> 
                <Linea height="10%" width="41%" top="35%" left="62%" c1="#DCDCDC" c2="#fc6767" c3="#61dafb" c4="#73fc67" c5="pink" c6="#fcbb67" width1="25%" transform="scaleX(-1)" v1={56} v2={55} v3={54} v4={53} v5={52} v6=""/> 
                <Linea height="10%" width="41%" top="9.7%" left="47.6%" c1="#DCDCDC" c2="#73fc67" c3="#fc6767" c4="pink" c5="#fcf267" c6="#61dafb" width1="25%" transform="rotate(+120deg)" v1={61} v2={60} v3={59} v4={58} v5={57} v6="" /> 
                <Linea height="10%" width="41%" top="9.7%" left="18.6%" c1="#DCDCDC" c2="pink" c3="#73fc67" c4="#fcf267" c5="#fcbb67" c6="#fc6767" width1="25%" transform="rotate(+60deg)" v1={66} v2={65} v3={64} v4={63} v5={62} v6=""/> 
                <Linea height="10%" width="41%" top="35%" left="4%" c1="#DCDCDC" c2="#fcf267" c3="pink" c4="#fcbb67" c5="#61dafb" c6="#73fc67" width1="25%" transform="0" v1={71} v2={70} v3={69} v4={68} v5={67} v6=""/>
              ...
              <div className="App-CuadradoNegro"  style= {{width:"50%", height:"60%", top: "15%", left: "24.5%", position:"absolute", zIndex:"6", backgroundColor: "#000000"}}>
                ...
                <div style = {{marginTop: "2%"}}>
                    <a style={{color:"white",fontSize:"30px"}}>
                        Los ganadores de la partida han sido : <a style={{color:"green", fontSize:"30px"}}> {ganador} y {ganador1} </a>
                    </a>
                    <div>
