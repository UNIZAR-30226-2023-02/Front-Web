...
const ModoEquipos = () => {
  const [body, setBody] = useState({ nombre_sala: "", tiempo_respuesta: "10", password_sala: "", n_jugadores: "4", tipo_partida: "Equipo" });
  ...
  return (
    <div className="App">
      <div className = "App-header" > 
        <div className="App-titulo"  style= {{top: "7%"}}> Modo Parejas
        ...
        <div className="App-CuadradoAmarillo" style={{ width: "1730px", height: "620px", position: "absolute", zIndex: "1", top: "24%", left: "5%"}}>
          <div style={{marginTop:"10px"}}>
            <a  style= {{ color: "#174a67", fontSize: "60px", fontStyle: "italic" }}>
                Creación de Sala de modo Parejas:   
            </a>
